...
constexpr LevelData level = {{
        ...
        {.true_car = 1, .ptrMesh = nullptr, .texGLptr = 0, .carID = 1, .orientation = 1, .tex = 4, .basepose = NULL, .grid2d = {3, 0}},
        ...
        {.true_car = 1, .ptrMesh = nullptr, .texGLptr = 0, .carID = 3, .orientation = 0, .tex = 10, .basepose = NULL, .grid2d = {0, 3}},
